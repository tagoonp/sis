...
<body class="vertical-layout vertical-menu-modern dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0 text-dark  d-none d-sm-block">User information</h5>
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12 pb-2">
                        ...
                        <h3 class=" mb-0 kb-title text-dark pt-0 pb-0 "><?php echo $std_basic_info['FNAME']. " " . $std_basic_info['LNAME'];?>  | ID : <?php echo $id; ?></h3>
                    </div>
                        ...
                        <div class="email-app-menu">
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="app-user-info?id=<?php echo $id; ?>&page_id=2" class="list-group-item <?php if($page_id == '2'){ echo "active"; } ?>">
                                        <div class="fonticon-wrap d-inline mr-25">
                                    ...
                                    <a href="app-user-info?id=<?php echo $id; ?>&page_id=7" class="list-group-item <?php if($page_id == '7'){ echo "active"; } ?>">
                                        <div class="fonticon-wrap d-inline mr-25">
                    ...
                    <div class="col-12 col-sm-9">
                        ...
                        switch ($page_id) {
                            case "1":
                                require_once('./comp/basic_user_info.php');
                                break;
                            case "2":
    ...
    <script>
        ...
        function sendMessage(){
            $('#txtLineMessage').removeClass('is-invalid')
            if($("#txtLineMessage").val() == ''){
                $('#txtLineMessage').addClass('is-invalid')
                return ;
            }
            var param = {
                uid: $("#txtUid").val(),
                message: $('#txtLineMessage').val(),
                to_id: $('#txtToUsername').val(),
                to_token: $('#txtLineToken').val()
            }

            preload.show()

            var jxr = $.post(api + 'staff?stage=send_message', param, function(){}, 'json')
