                                            ...
                                            if(($res) && ($res['status'])){
                                                ...
                                                foreach ($res['data'] as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <?php 
                                                            $strSQL = "SELECT COUNT(*) cn FROM sis_advisor WHERE adv_username = '".$row['USERNAME']."' AND adv_delete = '0'";
                                                            $resCount = $db->fetch($strSQL, false, false);
                                                            if($resCount){ echo '<i class="bx bx-user"></i> '.$resCount['cn']; }else{ echo '<i class="bx bx-user"></i> 0';}
                                                        ?>
                                                        </td>
                                                        <td class="text-right">
