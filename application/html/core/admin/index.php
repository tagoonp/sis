                            ...
                            <div class="row match-height">
                                <div class="col-md-4 col-sm-6 kb-search-content">
                                    <div class="card kb-hover-1">
                                        <div class="card-body text-center">
                                            <a href="Javascript:window.open('<?php echo DOE_DOMAIN; ?>application/controller/bypass_login?uid=<?php echo $_SESSION['doe_uid']; ?>&token=<?php echo $_SESSION['doe_token']; ?>', '_blank')">
                                                <div class=" mb-1">
