...
$strSQL = "SELECT * FROM research a INNER JOIN rec_progress b ON a.id_rs = b.rp_id_rs WHERE a.id_rs = '$project_id' AND b.rp_session = '$psid' AND b.rp_uid = '".$_SESSION['rmis_uid']."' AND b.rp_sending_status = '1'";
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <table class="table table-striped mb-0" style="font-size: 0.8em;">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 50%;"><div>หมายเลขโครงการ : </div><span class="badge badge-success round" style="font-size: 1.3em; margin-top: 3px;"><?php echo $resResearch['code_apdu']; ?></span></td>
                                                        <td><div>Protocol No. : </div><span class="" style="font-size: 1.3em; margin-top: 3px;"><?php if($resResearch['protocol_no'] == ''){ echo "-"; }else{  echo $resResearch['protocol_no']; } ?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2"><div>ชื่อโครงการ : </div><div class="text-dark" style="font-size: 1.3em; margin-top: 3px;"><?php if($resResearch['title_th'] == '-'){ echo $resResearch['title_en']; }else{ echo $resResearch['title_th']. " (".$resResearch['title_en'].")";} ?></div></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="text-dark" style="font-size: 1.3em; margin-top: 3px;">
                                                            ...
                                                            $strSQL = "SELECT * FROM userinfo a 
                                                                       ...
                                                                       WHERE a.user_id = '".$resResearch['id']."' ORDER BY a.id_p DESC LIMIT 1";
                                                            ...
                                                            <table class="table table-striped text-dark">
                                                                <thead>
                                                                    <tr class="bg-secondary">
                                                                        <th class="text-white">ชื่อไฟล์ (ชื่อไฟล์จะปรากฏในใบรับรอง ควรมี version, date)</th>
                                                                        <th></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody id="closing_4">
                                                        ...
                                                        <div class="pt-1 mb-2 dn0"  id="hd52">
                                                            <table class="table table-striped text-dark">
                                                                <thead>
                                                                    <tr class="bg-secondary">
                                                                        <th class="text-white">ชื่อไฟล์ (ชื่อไฟล์จะปรากฏในใบรับรอง ควรมี version date)</th>
                                                                        <!-- ตั้งชื่อไฟล์ให้สื่อความหมาย ควรมี version, date เพราะจะปรากฏในเอกสารใบรับรอง -->
                                                                        <th></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody id="closing_8">
