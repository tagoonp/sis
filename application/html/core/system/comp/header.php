                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            ...
                            <li class="nav-item d-none d-lg-block"><a class="nav-link" target="_blank" href="https://medipe2.psu.ac.th/eustudent/study-calendar.html" data-toggle="tooltip" data-placement="top" title="Calendar"><i class="ficon bx bx-calendar-alt"></i></a></li>
                        </ul>
                        <!-- <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0">
                                ...
                                if($currentUser['ROLE_ADMIN'] == 'Y'){
                                    ?>
                                    <a class="dropdown-item" href="../../../controller/switch_role?to=admin"><i class="bx bx-sync mr-50"></i> Switch to admin</a>
                                    <?php
                                }

                                if($currentUser['ROLE_STAFF'] == 'Y'){
                                    ?>
                                    <a class="dropdown-item" href="../../../controller/switch_role?to=staff"><i class="bx bx-sync mr-50"></i> Switch to staff</a>
                                    <?php
                                }

                                if($currentUser['ROLE_LECTURER'] == 'Y'){
                                    ?>
                                    <a class="dropdown-item" href="../../../controller/switch_role?to=lecturer"><i class="bx bx-sync mr-50"></i> Switch to lecturer</a>
                                    <?php
                                }

                                if($currentUser['ROLE_STUDENT'] == 'Y'){
                                    ?>
                                    <a class="dropdown-item" href="../../../controller/switch_role?to=student"><i class="bx bx-sync mr-50"></i> Switch to student</a>
                                    <?php
                                }
                                ?>
                                <div class="dropdown-divider mb-0"></div>
                                <a class="dropdown-item" href="Javascript:authen.logout()"><i class="bx bx-power-off mr-50"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
