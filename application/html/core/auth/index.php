...
<head>
    ...
    <title>DOE-SIS :: Department of Epidemilogy Student Information System</title>
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                ...
                                                <h1 class="text-dark">DOE<span class="text-primary">-SIS</span> </h1>
                                                <h4 class="text-dark">Student Information System</h4>
                                            </div>
                                        </div>
