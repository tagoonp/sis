            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                if(($role == 'admin') || ($role == 'lecturer') || ($role == 'staff')){
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a class="d-flex align-items-center" href="dashboard-analytics.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Monitoring student</span></a></li>
                        </ul>
                    </li>
                    <?php
                }
                ...
                <li class=" nav-item <?php if($page == 'page-user-profile'){ echo "active"; }?>"><a href="Javascript:window.open('<?php echo DOE_DOMAIN; ?>application/controller/bypass_login?uid=<?php echo $_SESSION['doe_uid']; ?>&token=<?php echo $_SESSION['doe_token']; ?>', '_blank')"><i class="menu-livicon" data-icon="user"></i><span class="menu-title text-truncate" data-i18n="User Profile">User Profile</span></a></li>

                <?php 
                if(($role == 'admin') || ($role == 'lecturer') || ($role == 'staff')){
                    ?>
                    <li class=" navigation-header text-truncate"><span data-i18n="Apps">Management</span></li>
                    <li class=" nav-item <?php if($page == 'app-lecturer'){ echo "active"; }?>"><a href="app-lecturer"><i class="menu-livicon" data-icon="users"></i><span class="menu-title text-truncate" data-i18n="Calendar">Lecturer</span></a>
                    <li class=" nav-item <?php if($page == 'app-staff'){ echo "active"; }?>"><a href="app-staff"><i class="menu-livicon" data-icon="pencil"></i><span class="menu-title text-truncate" data-i18n="Calendar">Staff</span></a>
                    <li class=" nav-item <?php if($page == 'app-student'){ echo "active"; }?>"><a href="app-student"><i class="menu-livicon" data-icon="users"></i><span class="menu-title text-truncate" data-i18n="Calendar">Student</span></a>
                    <?php
                }
                ?>
