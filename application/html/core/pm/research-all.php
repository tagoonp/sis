        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1 pl-sm-1 pr-sm-1 pl-3 pr-3 pt-2 pt-sm-0">
                    <h3 class="text-white">โครงการวิจัยทั้งหมดของท่าน</h3>
                            ...
                            <table class="table table-stiped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: 1em !important; width: 200px;" class="text-white">วันที่อนุมัติครั้งแรก</th>
                                        <th style="font-size: 1em !important; width: 200px;" class="text-white">วันที่ปิดโครงการ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
                                        ...
                                        foreach ($recCheck['data'] as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;">
                                                    ...
                                                    <div class="pt-1">
                                                    <button class="btn btn-secondary" onclick="window.location = 'rec-report-list?id_rs=<?php echo $row['id_rs']; ?>'"><i class="bx bx-search"></i> ดูข้อมูล Initial review</button>
                                                        <?php 
                                                        if($row['id_status_research'] == '18'){
                                                            ?>
                                                            <button class="btn btn-secondary" onclick="window.location = 'rec-report-list?id_rs=<?php echo $row['id_rs']; ?>'"><i class="bx bx-search"></i> ดูข้อมูล Continuing review</button>
                                                            <?php
                                                        }
                                                        ?>
                                                ...
                                                <td style="vertical-align: top;">
                                                        <?php 
                                                        $strSQL = "SELECT rp_signdate FROM rec_progress WHERE rp_progress_status = '18' AND rp_id_rs = '".$row['id_rs']."' AND rp_progress_id IN ('closing', 'terminate') AND rp_delete_status = '0' AND rp_confirm_1 = '1'";
                                                        $resExp = $db->fetch($strSQL, false, false);
                                                        if($resExp){
                                                            echo $resExp['rp_signdate'];
                                                        }else{
                                                            echo "-";
                                                        }
                                                        ?>
