        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1 pl-sm-1 pr-sm-1 pl-3 pr-3 pt-2 pt-sm-0">
                    <h3 class="text-white">โครงการวิจัยที่รอการส่งของท่าน</h3>
                                        ...
                                        foreach ($recCheck['data'] as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;">
                                                    ...
                                                    <div class="pt-1">
                                                    <button class="btn btn-secondary" onclick="window.location = 'rec-report-list?id_rs=<?php echo $row['id_rs']; ?>'"><i class="bx bx-wrench"></i> ดำเนินการต่อ</button>
                                                    <button class="btn btn-danger" onclick="window.location = 'rec-report-list?id_rs=<?php echo $row['id_rs']; ?>'"><i class="bx bx-trash"></i> ลบ/ขอถอนแบบยื่นขอพิจารณา</button>
                                                    </div>
                                                </td>
