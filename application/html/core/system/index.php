            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0 text-dark">DOE Student information system</h5>
                            ...
                            <div class="row match-height">
                                ...
                                if($role == 'student'){
                                    ...
                                    <div class="col-md-4 col-sm-6 kb-search-content">
                                        <div class="card kb-hover-1">
                                            <div class="card-body text-center">
                                                <a href="page-study-info">
                                                    <div class=" mb-1">
                                                        <i class="livicon-evo" data-options="name: briefcase.svg; size: 50px; strokeColorAlt: #FDAC41; strokeColor: #5A8DEE; style: lines-alt; eventOn: .kb-hover-1;"></i>
                                                    </div>
                                                    <h5 class="text-dark">Study info.</h5>
                                                    <p class=" text-muted">But students more often neglect fact it is much more</p>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card kb-hover-2" style="cursor: pointer;">
                                            <div class="card-body text-center">
                                                <a href="../login/line">
                                                    ...
                                                    <h5 class="text-dark">Link with line</h5>
