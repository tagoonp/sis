        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1 pl-sm-1 pr-sm-1 pl-3 pr-3 pt-2 pt-sm-0">
                    <h3 class="text-white">ลงทะเบียนเสนอโครงการวิจัย</h3>
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i></a> หน้าแรก</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body" >
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="alert alert-danger mb-2" role="alert">
                            กรุณากรอกข้อมูลให้ครบถ้วนทุกส่วน (ทางซ้ายมือ) จนกว่าจะมีเครื่องหมาย <i class="bx bx-check-circle"></i> แสดงในแต่ละส่วนจนครบ
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="list-group list-group-flush">
                            <a href="./research-register?stage=1" class="list-group-item list-group-item-action border-0 d-flex <?php if($stage == 1){ echo "active"; }?>">
                                <div class="list-icon">
                                    <i class="badge-circle badge-circle-light-secondary bx bx-info-circle mr-1 text-primary"></i>
                                </div>
                            ...
                            <a href="./research-register?stage=2" class="list-group-item list-group-item-action border-0 d-flex <?php if($stage == 2){ echo "active"; }?>">
                                <div class="list-icon">
                                    <i class="badge-circle badge-circle-light-secondary bx bx-group mr-1 text-danger"></i>
                                </div>
                                <div class="list-content">
                                    <h5>ส่วนที่ 2 : </h5>
                                    <p class="mb-0">
                            ...
                            <a href="./research-register?stage=3" class="list-group-item list-group-item-action border-0 d-flex <?php if($stage == 3){ echo "active"; }?>">
                                <div class="list-icon">
                                    <i class="badge-circle badge-circle-light-secondary bx bx-dollar mr-1 text-success"></i>
                                </div>
                                <div class="list-content">
                                    <h5>ส่วนที่ 3 : </h5>
                                    <p class="mb-0">
                            ...
                            <a href="./research-register?stage=4" class="list-group-item list-group-item-action border-0 d-flex <?php if($stage == 4){ echo "active"; }?>">
                                <div class="list-icon">
                                    <i class="badge-circle badge-circle-light-secondary bx bx-comment mr-1 text-info"></i>
                                </div>
                                <div class="list-content">
                                    <h5>ส่วนที่ 4 :</h5>
                                    <p class="mb-0">
                            ...
                            <a href="./research-register?stage=5" class="list-group-item list-group-item-action border-0 d-flex <?php if($stage == 5){ echo "active"; }?>">
                                <div class="list-icon">
                                    <i class="badge-circle badge-circle-light-secondary bx bx-upload mr-1 text-info"></i>
                                </div>
                                <div class="list-content">
                                    <h5>ส่วนที่ 5 :</h5>
                                    <p class="mb-0">
                    ...
                    <div class="col-8">
                        <div class="card">
                            <!-- <div class="card-header bg-success text-white"> -->
                                <?php 
                                // if($stage == 1){ echo '<h4 class="text-white mb-0">ข้อมูลทั่วไปโครงการวิจัย</h3>'; }
                                // if($stage == 2){ echo '<h4 class="text-white mb-0">ผู้ร่วมวิจัย</h3>'; }
                                // if($stage == 3){ echo '<h4 class="text-white mb-0">ทุนวิจัย</h3>'; }
                                // if($stage == 4){ echo '<h4 class="text-white mb-0">สรุปย่อโครงการวิจัย</h3>'; }
                                // if($stage == 5){ echo '<h4 class="text-white mb-0">อัพโหลดเอกสาร</h3>'; }
                                ?>
                            <!-- </div> -->
                            <div class="card-body">
                                <?php 
                                if($stage == 1){ require ('./comp/path-1.php'); }
                                if($stage == 2){ require ('./comp/path-2.php'); }
                                if($stage == 3){ require ('./comp/path-3.php'); }
                                if($stage == 4){ require ('./comp/path-4.php'); }
                                if($stage == 5){ require ('./comp/path-5.php'); }
                                ?>
                            </div>
                        </div>
                    </div>
